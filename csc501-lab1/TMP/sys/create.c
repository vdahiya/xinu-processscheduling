 ...
 *
 * changelist:
 * 1) Added initialization of 'counter' in the pentry structure while creating a new process
 * */
					...
					/* array in the code)		*/
{
	...
	pptr->counter = priority;	/* (1)  quantum value is set to its process priority for newly created process	*/
